...
//send udp data.
int32_t net_sendto( const CSocket *pSocketId, const int8u_t *pData, const int32_t iDataLen );

//receive upp data.
int32_t net_recvfrom( const CSocket *pSocketId, int8u_t *pRecvDataBuf, const int32_t iRecvBufLen );
