...
int main( int argc, char **argv )
{
	...
	if ( iSocketId > 0 )
	{
		...
		printf( "init reactor ok..........\r\n" );
		
		memcpy( addr.pIP, pDomainName, strlen(pDomainName) );
		
		printf( "start to connect ............\r\n" );
		net_connect( iSocketId, &addr );
		
		printf( "connect edn...........\r\n" );
		
		printf( "start to create reactor..............\r\n" );
		iReactorId = net_reactor(  );

		printf( "create reactor end.............\r\n" );		
		
		register_reactor_callback( iReactorId, reactor_callback, NULL );
		
		add_reactor_socket( iReactorId, iSocketId, NULL );
		
		printf( "create socket ok.socket id-->%u.\r\n", iSocketId );
